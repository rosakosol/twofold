...
//
// Local is now a complete source for this, which it was not until 20261109000600. The feedback
// board's tables had no migration and existed only in the linked project, so regenerating from a
// local stack silently deleted feature_requests, feature_votes, feature_comments, feature_bookmarks,
// feature_subscribers, feature_notification_outbox and developer_updates from this file — and broke
// every query in src/lib/queries. That migration captured them, so `--local` is safe again.
  ...
  public: {
    Tables: {
      ...
      connection_request_reminders: {
        ...
        Relationships: [
          {
            foreignKeyName: "connection_request_reminders_request_id_fkey"
            columns: ["request_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "connection_request_reminders_sender_id_fkey"
            columns: ["sender_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      connection_requests: {
        Row: {
          ...
          invite_code: string
          inviter_id: string
          origin: Database["public"]["Enums"]["connection_request_origin"]
          requester_id: string
      ...
      couple_archive_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "couple_archive_preferences_couple_id_fkey"
            columns: ["couple_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "couple_archive_preferences_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      flight_additions: {
        ...
        Relationships: [
          {
            foreignKeyName: "flight_additions_added_by_fkey"
            columns: ["added_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "flight_additions_couple_id_fkey"
            columns: ["couple_id"]
            isOneToOne: false
            referencedRelation: "couples"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "flight_additions_flight_id_fkey"
            columns: ["flight_id"]
            isOneToOne: false
      ...
      notification_preferences: {
        Row: {
          ...
          profile_id: string
          streak_ending_reminder: boolean
          updated_at: string
        }
        Insert: {
          created_at?: string
      ...
      profiles: {
        Row: {
          ...
          partner_subscription_lapse_partner_name: string | null
          partner_subscription_lapse_shown: boolean
      ...
      record_export_credits: {
        ...
        Relationships: [
          {
            foreignKeyName: "record_export_credits_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      streak_reminder_sends: {
        ...
        Relationships: [
          {
            foreignKeyName: "streak_reminder_sends_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      streak_repair_credits: {
        Row: {
          consumed_at: string | null
          consumed_for_couple_id: string | null
          granted_at: string
          id: string
          profile_id: string
          transaction_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "streak_repair_credits_consumed_for_couple_id_fkey"
            columns: ["consumed_for_couple_id"]
            isOneToOne: false
            referencedRelation: "couples"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "streak_repair_credits_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      couple_archive_state: {
        Args: { p_couple_id: string }
        Returns: {
          hidden: boolean
        }[]
      }
      couple_is_subscribed: { Args: { p_couple_id: string }; Returns: boolean }
      create_invite_code: {
        Args: never
        Returns: {
          code: string
      ...
      delete_game_deck: { Args: { p_deck_id: string }; Returns: Json }
      delete_own_account: {
        Args: { p_delete_shared_data?: boolean }
        Returns: undefined
      }
      dormancy_cohort: {
        Args: { p_now?: string }
      ...
      list_couple_day_bounds: {
        ...
        Returns: {
          couple_id: string
          current_streak: number
          early_reminder_sent_date: string
          final_reminder_sent_date: string
          local_date: string
          next_boundary: string
          partner_a_id: string
          partner_b_id: string
      ...
      record_api_call: {
        Args: {
          ...
          p_endpoint: string
          p_fa_flight_id?: string
          p_flight_id?: string
          p_provider: string
          p_served_flight_count?: number
          p_status?: number
          p_was_retry?: boolean
        }
        Returns: undefined
      ...
      redeem_invite_code: {
        Args: {
          p_code: string
          p_origin?: Database["public"]["Enums"]["connection_request_origin"]
        }
        Returns: {
      ...
      redundant_subscription: {
        ...
        Returns: {
          ...
          redundant_profile_id: string
        }[]
      }
      register_device_push_token: {
        Args: { p_apns_token: string; p_environment?: string }
        Returns: undefined
      }
      repair_couple_streak: {
        Args: never
        Returns: {
          current_streak: number
          error_message: string
      ...
      repair_streak_with_monthly_freeze: {
        Args: never
        Returns: {
          current_streak: number
          error_message: string
      ...
      send_connection_request_reminder: {
    ...
    Enums: {
      connection_request_origin: "code" | "link"
