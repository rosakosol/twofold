...
__name(json, "json");
async function sendEmails(env, email) {
  const send = /* @__PURE__ */ __name((payload) => fetch("https://api.resend.com/emails", {
    method: "POST",
    headers: {
...
// ../.wrangler/tmp/pages-YtEHTz/functionsRoutes-0.24000214709124024.mjs
var routes = [
  {
