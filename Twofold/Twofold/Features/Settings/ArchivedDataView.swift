...
//  Twofold
//
//  Read-only history of past partnerships, reached from Settings -> Help -> Archived Data.
//  Removing a partner dissolves the couple rather than deleting it, so everything shared with them
//  lands here instead of vanishing outright.
//
//  That Help row is deliberately ungated, and is the only route in. This screen used to sit inside
